...
Stephan Hagemann's excellent talk from last year's MountainWest RubyConf on [component-based architectures in Ruby and Rails](https://www.youtube.com/watch?v=-54SDanDC00).
